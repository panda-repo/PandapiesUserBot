...
@Pandapies.on_message(filters.command("ud", prefixes=HANDLER) & filters.user(OWNER_ID))
...
@Pandapies.on_message(filters.command("tr", prefixes=HANDLER) & filters.user(OWNER_ID))
